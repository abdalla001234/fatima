...
<body>
   ...
   <div class="subject">
	   	<span><span style="color:lightgrey">مواليد تاريخ </span>     
			   <?php $search = $_GET['dateselect'];
			   echo $search ?> 
			</span><br>
	<span style="color:rgb(255, 136, 0)">   المواليد حسب تاريخ الميلاد </span>
     <br>
...
<table>
	...
	<?php include_once ("db_conn.php");?>
         <?php
               $search = $_GET['dateselect'];
			  echo $search;
               $sql = "SELECT childname,dateofbirth,birthplace FROM  names WHERE dateofbirth like '%$search%'  ";
